...
import { ActivityIndicatorProps, Dimensions, Platform, TextStyle, ViewStyle } from 'react-native'
...
type DefaultProps = {
  ...
  onFastForward: () => void
  onRewind: () => void
  onDidJustFinish: () => void
  onSubmitCompletion: (progress: number) => void
  onPlayPause: (isPaused: boolean) => void
  onCompletionBodyPress?: () => void
  textStyle: TextStyle
